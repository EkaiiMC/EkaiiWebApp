export default function PinkHoverDisplay({index, title, text, className} : {index?: number, title: string, text: string, className?: string}) {
  return (
    <div className={"relative flex flex-col m-[30px_30px] p-7 bg-bgLightGray shadow-[0px_0px_10px] shadow-bgDarkGray text-lg text-justify transition-all ease-in-out hover:bg-pinkText duration-500 " + className}>
