...
export default function Page() {
  return (
    <>
      <Header />
      <main>
        <div className={"flex justify-center bg-darkerGray items-center w-full h-[100vh]"}>
          <div className={"flex flex-col justify-center items-center"}>
            <Image src={"/images/404.svg"} alt={"404"} className={"w-[60vw] h-auto min-h-[125px] mb-3"} height={1000}
                   width={1000}/>
            <div className={"flex flex-row w-[35vw] items-center justify-center"}>
              <Image src={"/images/vanille.svg"} alt={"vanille"} className={"w-auto h-[96px] mb-10"} height={96}
                     width={96}/>
