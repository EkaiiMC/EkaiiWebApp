...
export default async function Gallery() {
  ...
  let res = images.map((image) => {
    return (
      <div key={image.id} className={'text-lg flex flex-col items-center gallery-image m-2 relative shadow max-h-[360px] w-auto'}>
        ...
        <Image src={image.imagePath} alt={image.title} key={image.id} width={1920} height={1080} className={'max-h-[360px] w-auto border-4 border-bgDarkGray bg-bgLightGray'}/>
